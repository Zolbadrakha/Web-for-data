...
const Signup = () => {
    ...
    const signup = () => {
        const { name, email, age, niveau, password, reEnterPassword } = user
        if (name && email && age && niveau && password && (password === reEnterPassword)) {
    ...
    return (
        <div className="register">
            ...
            <input type="text" name="age" value={user.age} placeholder="Таны нас" onChange={handleChange}></input>
            <input type="text" name="niveau" value={user.niveau} placeholder="Таны франц хэлний түвшин" onChange={handleChange}></input>
